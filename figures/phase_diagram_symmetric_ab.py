"""
Legacy single-panel Hill plot (symmetric a/b=1): π_high/π_bind contours over (K_G2, K_G1).
Same model as phase_diagram_combined_contours.py with b raised to b = a (a/b = 1).
Writes only phase_diagram_symmetric_ab.png next to this script. This single-panel
legacy plot is superseded by the cross-prior grid produced by phase_diagram_grid.py.
...
Parameters: n=2, a=0.8, b=0.8, d=1.0, u_d=+0.1.
"""
...
n   = 2
a   = 0.8    # base parameters: favorable working point
b   = 0.8    # raised from 0.3 to match a (a/b = 1, vs a/b ≈ 2.67 at the asymmetric baseline)
d   = 1.0
u_d = 0.1
...
levels_b = [-1.5, -1.2, -1.0, -0.5, -0.25, 0.1, 0.25]
...
ax.set_title(
    f"a/b = 1 (symmetric lever weights)\n"
...
for _out in [os.path.join(_here, "phase_diagram_symmetric_ab.png")]:
